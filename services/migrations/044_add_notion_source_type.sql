...
CHECK (source_type IN ('google_drive', 'gmail', 'confluence', 'jira', 'slack', 'github', 'local_files', 'web', 'notion'));
...
CHECK (provider IN ('google', 'slack', 'atlassian', 'github', 'microsoft', 'notion'));
