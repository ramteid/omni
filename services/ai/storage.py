...
class ContentStorage:
    ...
    def __init__(self, bucket: str, content_blobs_repo: ContentBlobsRepository, region: Optional[str] = None):
        self.bucket = bucket
...
class PostgresContentStorage:
    ...
    async def get_text(self, content_id: str) -> str:
        ...
        if blob.storage_backend != 'postgres':
            raise ValueError(f"Content {content_id} has storage_backend '{blob.storage_backend}', expected 'postgres'")
