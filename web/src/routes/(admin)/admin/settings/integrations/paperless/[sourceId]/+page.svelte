<script lang="ts">
    ...
    import { ArrowLeft, AlertCircle, Loader2, FileText, Trash2 } from '@lucide/svelte'
    ...
    const origUrl = cfg.url ?? ''

    $effect(() => {
        hasUnsavedChanges =
            enabled !== origEnabled || url !== origUrl || apiKey !== ''
    })
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <Card.Description class="mt-1">
                                Index documents from a Paperless-ngx document management system
                            </Card.Description>
                        </div>
                ...
                <Card.Content class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            <Label for="url">Paperless-ngx URL</Label>
                            <Input
                                id="url"
                                name="url"
                                bind:value={url}
