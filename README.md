...
- **Unified Workplace Search Engine**: Connect all your workplace apps - Google Drive/Gmail, Slack, Confluence, and more. Omni brings together scattered context and knowledge from across your organization into a single, intelligent interface.
...
- **Bring Your Own LLM**: Choose the LLM that fits your needs - connect to Anthropic, OpenAI, or Gemini; or use open-weight models via vLLM for complete data privacy. Full flexibility without vendor lock-in.
...
- **HubSpot** - Contacts, companies, deals, tickets, etc.
- **Local Files** - File system indexing

### Work In Progress/Coming Soon
- **MS 365** - Outlook, Sharepoint, OneDrive
